...
import no.runsafe.peeveeeee.RatingHandler;
import no.runsafe.peeveeeee.customevents.WickedSickSpreeEvent;
import no.runsafe.peeveeeee.repositories.PlayerScoresRepository;
...
public class PlayerDeath implements IConfigurationChanged, IPlayerDeathEvent
{
	...
	public void OnPlayerDeathEvent(RunsafePlayerDeathEvent event)
	{
		...
		if (!killed.getWorldName().equals(pveWorldName))
			return;
	...
	{
		this.pvpWorldName = configuration.getConfigValueAsString("pveWorld");
