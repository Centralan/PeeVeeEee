...
import no.runsafe.peeveeeeearena.PvPArenaEngine;
import no.runsafe.peeveeeeearena.customitems.items.ICustomItem;
...
{
	public CustomItemHandler(ICustomItem[] customItems, PvEArenaEngine pveEngine)
	{
		this.pveEngine = pveEngine;
	...
	public boolean OnPlayerRightClick(IPlayer player, RunsafeMeta usingItem, IBlock targetBlock)
	{
		if (usingItem != null)
		{
			...
			if (itemName != null)
			{
				...
				{
					if (this.pveEngine.isInPvEZone(player))
					{
	...
	private final PvEArenaEngine pveEngine;
}
