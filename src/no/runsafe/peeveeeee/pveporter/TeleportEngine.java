package no.runsafe.peeveeeee.pvpporter;
...
public class TeleportEngine implements IConfigurationChanged
{
	...
	{
		IWorld pveWorld = configuration.getConfigValueAsWorld("pveWorld");

		if (pveWorld == null)
		{
			setup = false;
			console.logWarning("Invalid world supplied: %s. Teleportation disabled.", configuration.getConfigValueAsString("pveWorld"));
			return;
		}
